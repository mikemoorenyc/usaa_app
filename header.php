...
global $siteTitle;
$siteTitle = 'USAA Real Estate Company';
...
<link href='<?php echo $siteDir;?>/css/main.css?ts=<?php echo time();?>' rel='stylesheet' type='text/css'>
...
<script src="<?php echo $siteDir;?>/templates.js?v=<?php echo time();?>"></script>
